 ...
 */
public class NotCorrectClassStringUseParserInterface extends ASTVisitor implements ParserInterface
{
    /**
    ...
    public Result execute(String fileName) {
        return new Result(3,-1,false);
    }

    public NotCorrectClassStringUseParserInterface(CodePreparation codePreparation)
    {
