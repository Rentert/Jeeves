 ...
 */
public class UseReturnOnTryCatchFinallyParser extends ASTVisitor implements ParserInterface
{
    /**
    ...
    public Result execute(String fileName) {
        return new Result(8,-1,false);
    }


    public UseReturnOnTryCatchFinallyParser(CodePreparation preparation)
    {
